...
const CHARACTER_DETAILS = [
  ...
  },
  {
    ...
    trait: '공격하지 못하는 순수 힐러다. 소환 비용이 낮아져 더 가볍게 투입할 수 있다.'
  },
  {
    id: 'baduk',
    name: '박바둑',
  ...
  },
  {
    ...
    trait: '개별 체력이 크게 낮아져 광역 공격과 타워에 더 쉽게 정리된다. 이동속도가 빠른 돌진형 카드다.'
  },
  {
    id: 'jimin',
    name: '지민',
    ...
    trait: '드립 동작 중에는 무방비라 피격되면 공격이 취소될 수 있다. 준비 동작과 공격 주기는 빠르지만, 전체 피해 하향으로 한 방 위력은 낮아졌다.'
  },
  {
    id: 'mythos',
    name: '미토스건휘',
  ...
  },
  {
    ...
    trait: '붙은 대상은 루이를 공격하지 못하고 묶인다. 흡혈 피해가 낮아져 제압력보다 방해 역할에 더 가까워졌다.'
  }
];
