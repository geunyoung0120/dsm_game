...
const PATCH_NOTICES = [
  {
    ...
    date: '2026.06.26',
    items: [
      '자이언트 ZICK 이동속도 40% 감소',
      'OSJ 이동속도 50% 감소',
      '창GPT 사거리 120, 전방 폭 260으로 조정',
      '진해 벚꽃나무 사거리 130으로 감소',
      '빼트맨 HP 350으로 감소'
    ],
    details: [
      '자이언트 ZICK의 이동속도를 36에서 21.6으로 낮춰 건물에 도착하는 시간을 더 길게 만들었다.',
      'OSJ의 이동속도를 38에서 19로 낮춰 밀치기형 탱커가 전장에 진입하는 속도를 줄였다.',
      '창GPT는 전방 사거리를 120으로 줄이고, 대신 텍스트 스트림 가로 폭을 260으로 넓혀 양옆 압박을 강화했다.',
      '진해 벚꽃나무의 사거리는 175에서 130으로 낮췄다.',
      '빼트맨의 HP는 410에서 350으로 낮췄다.'
    ]
  },
  {
...
const CHARACTER_DETAILS = [
  ...
  },
  {
    ...
    ability: '플레이어가 전장 위치 하나를 지정하면 벚꽃나무 건물이 배치된다. 건물은 움직이지 않고, 배치 후 20초 동안 체력이 조금씩 줄어든다. 살아있는 동안 1초마다 사거리 130 안의 가장 가까운 적 유닛에게 벚꽃잎을 날려 100 피해를 준다.',
