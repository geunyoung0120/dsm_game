...
const CHARACTER_DETAILS = [
  ...
  },
  {
    ...
    stats: [
      ...
      ['공격 주기', '1.155초'],
      ['이동속도', '41'],
      ['광주 탱크', '1.5초마다 HP 290 / 공격력 17'],
      ['출격 효과', '전투 시간 +30초']
    ],
    ability: '전장에 등장하는 순간 왕의 귀환 임팩트가 깔리며 전투 시간이 30초 추가된다. X2 또는 X3 엘릭서 구간에 등장했다면 추가된 30초 동안 그 배율이 유지된다. 전장에 있는 동안 항상 1.5초마다 HP 290, 공격력 17의 광주 탱크를 하나씩 소환한다. 본체는 HP 2300, 공격력 80의 근접 단일 공격을 한다.',
    trait: '한 경기에서 한 번만 사용할 수 있다. 광주 탱크 체력이 보강되어, 전투 시간을 늘리는 후반 변수와 지속 압박을 함께 만드는 카드다.'
  },
  {
    id: 'kimrui',
    name: '김루이',
