...
const PATCH_NOTICES = [
  {
    title: '대.근.영 본체와 소환수 상향',
    date: '2026.07.03',
    items: [
      '대.근.영 HP 2500으로 증가',
      '대.근.영 공격력 90으로 증가',
      '광주 탱크 HP 350, 공격력 30으로 증가'
    ],
    details: [
      '대.근.영 본체 HP를 2300에서 2500으로 올리고, 공격력을 80에서 90으로 올렸다.',
      '대.근.영이 소환하는 광주 탱크의 HP를 290에서 350으로 올리고, 공격력을 17에서 30으로 올렸다.'
    ]
  },
  {
    title: '대.근.영 소환수 체력 상향',
    date: '2026.07.02',
    items: [
      '광주 탱크 HP 290으로 증가',
      '대.근.영 지속 압박 생존력 상향'
    ...
    details: [
      '대.근.영이 소환하는 광주 탱크의 HP를 190에서 290으로 100 올렸다.',
      '공격력과 소환 주기는 그대로 유지하고, 전장에 남아 압박하는 시간을 늘렸다.'
    ]
  },
  {
    title: '창GPT·허선 코스트 조정',
    date: '2026.07.01',
    items: [
      '창GPT 8 엘릭서로 증가',
      '창GPT 공격력 165로 감소',
    ...
    details: [
      '창GPT의 비용을 7 엘릭서에서 8 엘릭서로 올렸다.',
      '창GPT의 텍스트 스트림 피해량과 에러 자폭 피해를 180에서 165로 낮췄다.',
      '허선의 비용을 8 엘릭서에서 7 엘릭서로 낮춰 더 빠르게 꺼낼 수 있게 했다.'
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      '하이쿠 건휘 HP 330으로 감소',
      '박바둑 7 엘릭서로 감소',
      '절친 특성 출격 비용 7 엘릭서로 감소',
      '다과실 너드녀 사거리 20% 감소'
    ],
    details: [
      '하이쿠 건휘의 HP를 400에서 330으로 낮춰 초고속 원거리 카드의 생존력을 줄였다.',
      '박바둑의 비용을 8 엘릭서에서 7 엘릭서로 낮췄다.',
      '박바둑과 조현우가 함께 손패에 있을 때 발동하는 절친 특성 비용도 8 엘릭서에서 7 엘릭서로 낮췄다.',
      '다과실에서 나오는 너드녀의 사거리를 142에서 113.6으로 20% 낮췄다.'
    ]
  },
  {
    ...
    details: [
      ...
      '덱짜기에서 엘릭서 낮은 순/높은 순, 데미지 높은 순, HP 높은 순 정렬을 지원하고, 메인 맨 아래 넓은 영역에서 카드 픽률 TOP 5와 전체 픽률을 확인할 수 있다.'
    ]
  },
  {
...
const CHARACTER_DETAILS = [
  ...
  },
  {
    ...
    ability: '손끝에서 글자와 데이터가 줄줄이 이어지는 텍스트 스트림을 전방 사거리 110, 가로 폭 260 범위로 발사한다. 사거리는 짧지만 양옆으로 넓게 퍼지고 피해량이 165로 높다. 대신 공격할 때마다 25% 확률로 에러가 발생해 창GPT 자신도 165 피해를 받아, 중요한 순간에 도박처럼 쓰는 고위험 고보상 카드다.',
  ...
  },
  {
    ...
    stats: [
      ...
      ['이동속도', '40'],
      ['카오스 피해', '적 100 / 아군 29'],
      ['절친 출격', '7 엘릭서 / 스탯 감소 없음']
    ],
    ability: '갑자기 예측하기 어려운 행동을 하며 범위 안 적들에게 매우 큰 피해를 준다. 같은 범위의 아군도 약한 피해를 받는다. 스킬 발동 시점은 무작위다. 조현우와 손패에 함께 있으면 7 엘릭서로 둘이 동시에 기본 스탯 그대로 출격하며 전장에 절친 특성 문구가 뜬다.',
  ...
  },
  {
    ...
    ability: '근접 거리에서 한 대상에게 단일 공격을 한다. HP와 공격력이 20% 낮아졌고 비용은 4 엘릭서다. HP가 20% 이하로 떨어지면 분노해서 명존쎄!를 외치고 공격력이 50% 강해진다. 박바둑과 손패에 함께 있으면 7 엘릭서로 둘이 동시에 기본 스탯 그대로 출격하며 전장에 절친 특성 문구가 뜬다.',
  ...
  },
  {
    ...
    stats: [
      ...
      ['공격 주기', '1.155초'],
      ['이동속도', '41'],
      ['광주 탱크', '1.5초마다 HP 350 / 공격력 30'],
      ['출격 효과', '전투 시간 +30초']
    ],
    ability: '전장에 등장하는 순간 왕의 귀환 임팩트가 깔리며 전투 시간이 30초 추가된다. X2 또는 X3 엘릭서 구간에 등장했다면 추가된 30초 동안 그 배율이 유지된다. 전장에 있는 동안 항상 1.5초마다 HP 350, 공격력 30의 광주 탱크를 하나씩 소환한다. 본체는 HP 2500, 공격력 90의 근접 단일 공격을 한다.',
    trait: '한 경기에서 한 번만 사용할 수 있다. 본체와 광주 탱크가 모두 보강되어, 전투 시간을 늘리는 후반 변수와 지속 압박을 함께 만드는 카드다.'
  },
  {
    id: 'kimrui',
    name: '김루이',
