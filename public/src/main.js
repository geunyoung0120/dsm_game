...
const CHARACTER_DETAILS = [
  ...
  },
  {
    ...
    ability: '플레이어가 전장 위치 하나를 지정하면 그 위치에 다과실 건물이 배치된다. 건물은 움직이지 않고 적에게 타겟팅되어 파괴될 수 있다. 배치 후 24초 동안 체력이 조금씩 줄어들며, 설치 직후 너드남과 너드녀를 한 번 바로 소환하고 살아있는 동안 4초마다 다시 동시에 소환한다.',
